...
public class WhiteCloudDebris extends Sprite{
   ...
   private final static int SLOW_MO = 3;
    ...
    public WhiteCloudDebris(Sprite explodingSprite) {
        ...
        rasterMap.put(0, ImageLoader.getImage("exp/row-1-column-1.png"));
        rasterMap.put(1, ImageLoader.getImage("exp/row-1-column-2.png"));
        rasterMap.put(2, ImageLoader.getImage("exp/row-1-column-3.png"));
        rasterMap.put(3, ImageLoader.getImage("exp/row-2-column-1.png"));
        rasterMap.put(4, ImageLoader.getImage("exp/row-2-column-2.png"));
        rasterMap.put(5, ImageLoader.getImage("exp/row-2-column-3.png"));
        rasterMap.put(6, ImageLoader.getImage("exp/row-3-column-1.png"));
        rasterMap.put(7, ImageLoader.getImage("exp/row-3-column-2.png"));
        rasterMap.put(8, ImageLoader.getImage("exp/row-3-column-3.png"));
